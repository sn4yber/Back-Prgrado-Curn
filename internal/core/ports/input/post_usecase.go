...
type PostUseCase interface {
	...
	ListMyPosts(ctx context.Context, authorID uuid.UUID, limit, offset int) ([]PostResponse, error)
	ListPublicPosts(ctx context.Context, requesterID uuid.UUID, limit, offset int) ([]PostResponse, error)
	ListFeedPosts(ctx context.Context, requesterID uuid.UUID, limit, offset int) ([]PostResponse, error)
	ListPostsByUser(ctx context.Context, requesterID, userID uuid.UUID, limit, offset int) ([]PostResponse, error)
